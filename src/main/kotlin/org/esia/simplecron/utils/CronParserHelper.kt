...
object CronParserHelper {
    fun rangeExpressionParser(subExpression: String, allowedValues: IntRange): String {
    ...
    fun stepExpressionParser(subExpression: String, allowedValues: IntRange): String {
